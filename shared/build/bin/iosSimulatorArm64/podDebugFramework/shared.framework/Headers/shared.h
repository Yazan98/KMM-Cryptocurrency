...
__attribute__((swift_name("CoinaApplicationStateError")))
@interface SharedCoinaApplicationStateError : SharedCoinaApplicationState<SharedKotlinNothing *>
- (instancetype)initWithException:(SharedKotlinThrowable * _Nullable)exception responseCode:(int32_t)responseCode __attribute__((swift_name("init(exception:responseCode:)"))) __attribute__((objc_designated_initializer));
- (SharedKotlinThrowable * _Nullable)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (int32_t)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedCoinaApplicationStateError *)doCopyException:(SharedKotlinThrowable * _Nullable)exception responseCode:(int32_t)responseCode __attribute__((swift_name("doCopy(exception:responseCode:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinaApplicationStateSuccess")))
@interface SharedCoinaApplicationStateSuccess<__covariant T> : SharedCoinaApplicationState<T>
...
- (SharedCoinaApplicationStateSuccess<T> *)doCopyData:(T _Nullable)data __attribute__((swift_name("doCopy(data:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PriceExt")))
@interface SharedPriceExt : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)priceExt __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedPriceExt *shared __attribute__((swift_name("shared")));
- (NSString *)formatDecimalSeparatorPrice:(double)price __attribute__((swift_name("formatDecimalSeparator(price:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinaApiInfo")))
@interface SharedCoinaApiInfo : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)coinaApiInfo __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCoinaApiInfo *shared __attribute__((swift_name("shared")));
...
@property (readonly) NSString *COINS_BASE_URL __attribute__((swift_name("COINS_BASE_URL")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinaResponseCode")))
@interface SharedCoinaResponseCode : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)coinaResponseCode __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCoinaResponseCode *shared __attribute__((swift_name("shared")));
@property (readonly) int32_t ERROR_RESPONSE_CODE_BAD_REQUEST __attribute__((swift_name("ERROR_RESPONSE_CODE_BAD_REQUEST")));
@property (readonly) int32_t ERROR_RESPONSE_CODE_INTERNAL_SERVER_ERROR_END __attribute__((swift_name("ERROR_RESPONSE_CODE_INTERNAL_SERVER_ERROR_END")));
@property (readonly) int32_t ERROR_RESPONSE_CODE_INTERNAL_SERVER_ERROR_START __attribute__((swift_name("ERROR_RESPONSE_CODE_INTERNAL_SERVER_ERROR_START")));
@property (readonly) int32_t ERROR_RESPONSE_CODE_NOT_FOUND __attribute__((swift_name("ERROR_RESPONSE_CODE_NOT_FOUND")));
@property (readonly) int32_t ERROR_RESPONSE_CODE_REDIRECT __attribute__((swift_name("ERROR_RESPONSE_CODE_REDIRECT")));
@property (readonly) int32_t ERROR_RESPONSE_CODE_UNAUTHORIZED __attribute__((swift_name("ERROR_RESPONSE_CODE_UNAUTHORIZED")));
@property (readonly) int32_t RESPONSE_CODE_SUCCESS __attribute__((swift_name("RESPONSE_CODE_SUCCESS")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("HttpBaseClient")))
@interface SharedHttpBaseClient : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinaNoInternetException")))
@interface SharedCoinaNoInternetException : SharedKotlinException
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinaUnknownException")))
@interface SharedCoinaUnknownException : SharedKotlinException
...
__attribute__((swift_name("ApplicationApiManagerImplementation")))
@protocol SharedApplicationApiManagerImplementation
@required
...
*/
- (void)getCategoriesDatabase:(SharedCategoriesDataSource *)database onNewStateTriggered:(void (^)(SharedCoinaApplicationState<NSMutableArray<SharedCategoryModel *> *> *))onNewStateTriggered completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("getCategories(database:onNewStateTriggered:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getCoinInformationKey:(NSString *)key onNewStateTriggered:(void (^)(SharedCoinaApplicationState<SharedCoinInformation *> *))onNewStateTriggered completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("getCoinInformation(key:onNewStateTriggered:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getCoinsDatabase:(SharedCoinsDataSource *)database onNewStateTriggered:(void (^)(SharedCoinaApplicationState<NSMutableArray<SharedCoinModel *> *> *))onNewStateTriggered completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("getCoins(database:onNewStateTriggered:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getCoinsByCategoryNameCategoryName:(NSString *)categoryName onNewStateTriggered:(void (^)(SharedCoinaApplicationState<NSMutableArray<SharedCoinModel *> *> *))onNewStateTriggered completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("getCoinsByCategoryName(categoryName:onNewStateTriggered:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getExchangesDatabase:(SharedExchangesDataSource *)database onNewStateTriggered:(void (^)(SharedCoinaApplicationState<NSMutableArray<SharedExchangeModel *> *> *))onNewStateTriggered completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("getExchanges(database:onNewStateTriggered:completionHandler:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinaApiLinks")))
@interface SharedCoinaApiLinks : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)coinaApiLinks __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCoinaApiLinks *shared __attribute__((swift_name("shared")));
@property (readonly) NSString *COINS_LIST_CATEGORIES __attribute__((swift_name("COINS_LIST_CATEGORIES")));
...
- (SharedCoinInfoUseCase *)addDependenciesApiManager:(SharedApplicationApiManager *)apiManager __attribute__((swift_name("addDependencies(apiManager:)")));
- (NSString *)getUseCaseKey __attribute__((swift_name("getUseCaseKey()")));
...
@interface SharedGetCategoriesUseCase : SharedCoinaUseCase<SharedKotlinUnit *, NSMutableArray<SharedCategoryModel *> *>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
- (SharedGetCategoriesUseCase *)addDependenciesApiManager:(SharedApplicationApiManager *)apiManager database:(SharedCategoriesDataSource *)database __attribute__((swift_name("addDependencies(apiManager:database:)")));
- (NSString *)getUseCaseKey __attribute__((swift_name("getUseCaseKey()")));
...
- (SharedGetCategoryCoinsUseCase *)addDependenciesApiManager:(SharedApplicationApiManager *)apiManager __attribute__((swift_name("addDependencies(apiManager:)")));
- (NSString *)getUseCaseKey __attribute__((swift_name("getUseCaseKey()")));
...
- (SharedGetCoinsUseCase *)addDependenciesApiManager:(SharedApplicationApiManager *)apiManager database:(SharedCoinsDataSource *)database __attribute__((swift_name("addDependencies(apiManager:database:)")));
- (NSString *)getUseCaseKey __attribute__((swift_name("getUseCaseKey()")));
...
- (SharedGetExchangesUseCase *)addDependenciesApiManager:(SharedApplicationApiManager *)apiManager database:(SharedExchangesDataSource *)database __attribute__((swift_name("addDependencies(apiManager:database:)")));
- (NSString *)getUseCaseKey __attribute__((swift_name("getUseCaseKey()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinaStorageKeyValue")))
@interface SharedCoinaStorageKeyValue : SharedBase
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinaStorageKeys")))
@interface SharedCoinaStorageKeys : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)coinaStorageKeys __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCoinaStorageKeys *shared __attribute__((swift_name("shared")));
@property (readonly) NSString *IS_LOGGED_IN __attribute__((swift_name("IS_LOGGED_IN")));
@property (readonly) NSString *STORAGE_MAIN_KEY __attribute__((swift_name("STORAGE_MAIN_KEY")));
@end

__attribute__((swift_name("CoinaStorageProviderImplementation")))
@protocol SharedCoinaStorageProviderImplementation
@required
- (BOOL)isUserLoggedIn __attribute__((swift_name("isUserLoggedIn()")));
- (void)updateLoggedInUserNewState:(BOOL)newState __attribute__((swift_name("updateLoggedInUser(newState:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinaStorageProvider")))
@interface SharedCoinaStorageProvider : SharedBase <SharedCoinaStorageProviderImplementation>
- (instancetype)initWithProvider:(SharedCoinaStorageKeyValue *)provider __attribute__((swift_name("init(provider:)"))) __attribute__((objc_designated_initializer));
- (BOOL)isUserLoggedIn __attribute__((swift_name("isUserLoggedIn()")));
- (void)updateLoggedInUserNewState:(BOOL)newState __attribute__((swift_name("updateLoggedInUser(newState:)")));
@end

__attribute__((swift_name("CoinaBaseDataSource")))
@interface SharedCoinaBaseDataSource : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
 ...
 * @note This method has protected visibility in Kotlin source and is intended only for use by subclasses.
*/
- (void)closeRealmInstanceRealm:(id<SharedLibrary_baseRealm>)realm __attribute__((swift_name("closeRealmInstance(realm:)")));
- (NSString *)getDataSourceName __attribute__((swift_name("getDataSourceName()")));

/**
 * @note This method has protected visibility in Kotlin source and is intended only for use by subclasses.
*/
- (id<SharedLibrary_baseRealm>)getRealmInstance __attribute__((swift_name("getRealmInstance()")));
- (NSSet<id<SharedKotlinKClass>> *)getSchema __attribute__((swift_name("getSchema()")));

/**
 * @note This method has protected visibility in Kotlin source and is intended only for use by subclasses.
*/
- (BOOL)isDataSourceEmptyModel:(id<SharedKotlinKClass>)model __attribute__((swift_name("isDataSourceEmpty(model:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CategoriesDataSource")))
@interface SharedCategoriesDataSource : SharedCoinaBaseDataSource
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (NSMutableArray<SharedCategoryModel *> *)getCategories __attribute__((swift_name("getCategories()")));
- (NSString *)getDataSourceName __attribute__((swift_name("getDataSourceName()")));
- (NSSet<id<SharedKotlinKClass>> *)getSchema __attribute__((swift_name("getSchema()")));
- (BOOL)isDataSourceEmpty __attribute__((swift_name("isDataSourceEmpty()")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)writeCategoriesDataCategories:(NSMutableArray<SharedCategoryModel *> *)categories completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("writeCategoriesData(categories:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinsDataSource")))
@interface SharedCoinsDataSource : SharedCoinaBaseDataSource
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (NSMutableArray<SharedCoinModel *> *)getCoins __attribute__((swift_name("getCoins()")));
- (NSMutableArray<SharedCoinModel *> *)getCoinsBySearchQueryQuery:(NSString *)query __attribute__((swift_name("getCoinsBySearchQuery(query:)")));
- (NSString *)getDataSourceName __attribute__((swift_name("getDataSourceName()")));
- (NSSet<id<SharedKotlinKClass>> *)getSchema __attribute__((swift_name("getSchema()")));
- (BOOL)isDataSourceEmpty __attribute__((swift_name("isDataSourceEmpty()")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)writeCoinsDataData:(NSMutableArray<SharedCoinModel *> *)data completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("writeCoinsData(data:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ExchangesDataSource")))
@interface SharedExchangesDataSource : SharedCoinaBaseDataSource
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (NSString *)getDataSourceName __attribute__((swift_name("getDataSourceName()")));
- (NSMutableArray<SharedExchangeModel *> *)getExchanges __attribute__((swift_name("getExchanges()")));
- (NSSet<id<SharedKotlinKClass>> *)getSchema __attribute__((swift_name("getSchema()")));
- (BOOL)isDataSourceEmpty __attribute__((swift_name("isDataSourceEmpty()")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)writeExchangesDataExchanges:(NSMutableArray<SharedExchangeModel *> *)exchanges completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("writeExchangesData(exchanges:completionHandler:)")));
@end
...
@protocol SharedLibrary_baseRealmObject <SharedLibrary_baseBaseRealmObject>
@required
@end

__attribute__((swift_name("RealmCategory")))
@interface SharedRealmCategory : SharedBase <SharedLibrary_baseRealmObject>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property (class, readonly, getter=companion) SharedRealmCategoryCompanion *companion __attribute__((swift_name("companion")));
@property NSString * _Nullable content __attribute__((swift_name("content")));
@property NSString *id __attribute__((swift_name("id")));
@property NSMutableArray<NSString *> *images __attribute__((swift_name("images")));
@property SharedDouble * _Nullable marketGap __attribute__((swift_name("marketGap")));
@property NSString * _Nullable name __attribute__((swift_name("name")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RealmCategory.Companion")))
@interface SharedRealmCategoryCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedRealmCategoryCompanion *shared __attribute__((swift_name("shared")));
...
- (SharedCategoryModel *)toCategoryRealmCategory:(SharedRealmCategory *)realmCategory __attribute__((swift_name("toCategory(realmCategory:)")));
@end

__attribute__((swift_name("RealmCoinModel")))
@interface SharedRealmCoinModel : SharedBase <SharedLibrary_baseRealmObject>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property (class, readonly, getter=companion) SharedRealmCoinModelCompanion *companion __attribute__((swift_name("companion")));
@property NSString *id __attribute__((swift_name("id")));
@property NSString * _Nullable image __attribute__((swift_name("image")));
@property SharedLong * _Nullable marketGap __attribute__((swift_name("marketGap")));
@property SharedInt * _Nullable marketGapRank __attribute__((swift_name("marketGapRank")));
@property NSString * _Nullable name __attribute__((swift_name("name")));
@property SharedDouble * _Nullable percentChange __attribute__((swift_name("percentChange")));
@property SharedDouble * _Nullable price __attribute__((swift_name("price")));
@property NSString * _Nullable symbol __attribute__((swift_name("symbol")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RealmCoinModel.Companion")))
@interface SharedRealmCoinModelCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedRealmCoinModelCompanion *shared __attribute__((swift_name("shared")));
- (id)io_realm_kotlin_newInstance __attribute__((swift_name("io_realm_kotlin_newInstance()")));
- (id)io_realm_kotlin_schema __attribute__((swift_name("io_realm_kotlin_schema()")));
- (SharedCoinModel *)toCoinModelModel:(SharedRealmCoinModel *)model __attribute__((swift_name("toCoinModel(model:)")));
@property (readonly) NSString *MARKET_GAP_RANK __attribute__((swift_name("MARKET_GAP_RANK")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RealmExchangeModel")))
@interface SharedRealmExchangeModel : SharedBase <SharedLibrary_baseRealmObject>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property (class, readonly, getter=companion) SharedRealmExchangeModelCompanion *companion __attribute__((swift_name("companion")));
...
@property SharedInt * _Nullable yearEstablished __attribute__((swift_name("yearEstablished")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RealmExchangeModel.Companion")))
@interface SharedRealmExchangeModelCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedRealmExchangeModelCompanion *shared __attribute__((swift_name("shared")));
- (id)io_realm_kotlin_newInstance __attribute__((swift_name("io_realm_kotlin_newInstance()")));
- (id)io_realm_kotlin_schema __attribute__((swift_name("io_realm_kotlin_schema()")));
...
@protocol SharedCoinaAction
@required
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinaEither")))
@interface SharedCoinaEither<State, SecondState> : SharedBase
- (instancetype)initWithState:(State _Nullable)state secondState:(SecondState _Nullable)secondState __attribute__((swift_name("init(state:secondState:)"))) __attribute__((objc_designated_initializer));
- (State _Nullable)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (SecondState _Nullable)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedCoinaEither<State, SecondState> *)doCopyState:(State _Nullable)state secondState:(SecondState _Nullable)secondState __attribute__((swift_name("doCopy(state:secondState:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (void)onSecondStateTriggeredOnTriggered:(void (^)(SecondState _Nullable))onTriggered __attribute__((swift_name("onSecondStateTriggered(onTriggered:)")));
- (void)onStateTriggeredOnTriggered:(void (^)(State _Nullable))onTriggered __attribute__((swift_name("onStateTriggered(onTriggered:)")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SecondState _Nullable secondState __attribute__((swift_name("secondState")));
@property (readonly) State _Nullable state __attribute__((swift_name("state")));
@end

__attribute__((swift_name("CoinaSideEffect")))
@interface SharedCoinaSideEffect<Action, Result> : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (NSString *)getSideEffectKey __attribute__((swift_name("getSideEffectKey()")));
- (Result _Nullable)onExecuteSideEffectNewAction:(Action)newAction __attribute__((swift_name("onExecuteSideEffect(newAction:)")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CategoryModel")))
@interface SharedCategoryModel : SharedBase
- (instancetype)initWithId:(NSString * _Nullable)id name:(NSString * _Nullable)name content:(NSString * _Nullable)content marketGap:(SharedDouble * _Nullable)marketGap topCoins:(NSMutableArray<NSString *> * _Nullable)topCoins __attribute__((swift_name("init(id:name:content:marketGap:topCoins:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedCategoryModelCompanion *companion __attribute__((swift_name("companion")));
...
- (SharedDouble * _Nullable)component4 __attribute__((swift_name("component4()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSMutableArray<NSString *> * _Nullable)component5 __attribute__((swift_name("component5()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedCategoryModel *)doCopyId:(NSString * _Nullable)id name:(NSString * _Nullable)name content:(NSString * _Nullable)content marketGap:(SharedDouble * _Nullable)marketGap topCoins:(NSMutableArray<NSString *> * _Nullable)topCoins __attribute__((swift_name("doCopy(id:name:content:marketGap:topCoins:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property NSString * _Nullable content __attribute__((swift_name("content")));
...
@property SharedDouble * _Nullable marketGap __attribute__((swift_name("marketGap")));
@property NSString * _Nullable name __attribute__((swift_name("name")));
@property NSMutableArray<NSString *> * _Nullable topCoins __attribute__((swift_name("topCoins")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CategoryModel.Companion")))
@interface SharedCategoryModelCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCategoryModelCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
- (SharedRealmCategory *)toRealmCategoryCategory:(SharedCategoryModel *)category __attribute__((swift_name("toRealmCategory(category:)")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinCommunity")))
@interface SharedCoinCommunity : SharedBase
- (instancetype)initWithFacebookLikes:(SharedLong * _Nullable)facebookLikes twitterFollowers:(SharedLong * _Nullable)twitterFollowers redditSubscribers:(SharedLong * _Nullable)redditSubscribers redditAveragePosts:(SharedDouble * _Nullable)redditAveragePosts redditAverageComments:(SharedDouble * _Nullable)redditAverageComments __attribute__((swift_name("init(facebookLikes:twitterFollowers:redditSubscribers:redditAveragePosts:redditAverageComments:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedCoinCommunityCompanion *companion __attribute__((swift_name("companion")));
...
- (SharedLong * _Nullable)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (SharedDouble * _Nullable)component4 __attribute__((swift_name("component4()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedDouble * _Nullable)component5 __attribute__((swift_name("component5()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedCoinCommunity *)doCopyFacebookLikes:(SharedLong * _Nullable)facebookLikes twitterFollowers:(SharedLong * _Nullable)twitterFollowers redditSubscribers:(SharedLong * _Nullable)redditSubscribers redditAveragePosts:(SharedDouble * _Nullable)redditAveragePosts redditAverageComments:(SharedDouble * _Nullable)redditAverageComments __attribute__((swift_name("doCopy(facebookLikes:twitterFollowers:redditSubscribers:redditAveragePosts:redditAverageComments:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedLong * _Nullable facebookLikes __attribute__((swift_name("facebookLikes")));
@property (readonly) SharedDouble * _Nullable redditAverageComments __attribute__((swift_name("redditAverageComments")));
@property (readonly) SharedDouble * _Nullable redditAveragePosts __attribute__((swift_name("redditAveragePosts")));
@property (readonly) SharedLong * _Nullable redditSubscribers __attribute__((swift_name("redditSubscribers")));
@property (readonly) SharedLong * _Nullable twitterFollowers __attribute__((swift_name("twitterFollowers")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinCommunity.Companion")))
@interface SharedCoinCommunityCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCoinCommunityCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinDescription")))
@interface SharedCoinDescription : SharedBase
...
@property (class, readonly, getter=companion) SharedCoinDescriptionCompanion *companion __attribute__((swift_name("companion")));
- (NSString * _Nullable)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedCoinDescription *)doCopyValue:(NSString * _Nullable)value __attribute__((swift_name("doCopy(value:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinDescription.Companion")))
@interface SharedCoinDescriptionCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCoinDescriptionCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinDeveloper")))
@interface SharedCoinDeveloper : SharedBase
- (instancetype)initWithForks:(SharedLong * _Nullable)forks stars:(SharedLong * _Nullable)stars subscribers:(SharedLong * _Nullable)subscribers totalIssues:(SharedLong * _Nullable)totalIssues closedIssues:(SharedLong * _Nullable)closedIssues pullRequestsMerged:(SharedLong * _Nullable)pullRequestsMerged contributors:(SharedLong * _Nullable)contributors __attribute__((swift_name("init(forks:stars:subscribers:totalIssues:closedIssues:pullRequestsMerged:contributors:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedCoinDeveloperCompanion *companion __attribute__((swift_name("companion")));
- (SharedLong * _Nullable)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedLong * _Nullable)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedLong * _Nullable)component3 __attribute__((swift_name("component3()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedLong * _Nullable)component4 __attribute__((swift_name("component4()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedLong * _Nullable)component5 __attribute__((swift_name("component5()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedLong * _Nullable)component6 __attribute__((swift_name("component6()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedLong * _Nullable)component7 __attribute__((swift_name("component7()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedCoinDeveloper *)doCopyForks:(SharedLong * _Nullable)forks stars:(SharedLong * _Nullable)stars subscribers:(SharedLong * _Nullable)subscribers totalIssues:(SharedLong * _Nullable)totalIssues closedIssues:(SharedLong * _Nullable)closedIssues pullRequestsMerged:(SharedLong * _Nullable)pullRequestsMerged contributors:(SharedLong * _Nullable)contributors __attribute__((swift_name("doCopy(forks:stars:subscribers:totalIssues:closedIssues:pullRequestsMerged:contributors:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedLong * _Nullable closedIssues __attribute__((swift_name("closedIssues")));
@property (readonly) SharedLong * _Nullable contributors __attribute__((swift_name("contributors")));
@property (readonly) SharedLong * _Nullable forks __attribute__((swift_name("forks")));
@property (readonly) SharedLong * _Nullable pullRequestsMerged __attribute__((swift_name("pullRequestsMerged")));
@property (readonly) SharedLong * _Nullable stars __attribute__((swift_name("stars")));
@property (readonly) SharedLong * _Nullable subscribers __attribute__((swift_name("subscribers")));
@property (readonly) SharedLong * _Nullable totalIssues __attribute__((swift_name("totalIssues")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinDeveloper.Companion")))
@interface SharedCoinDeveloperCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCoinDeveloperCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinIcon")))
@interface SharedCoinIcon : SharedBase
- (instancetype)initWithThumb:(NSString * _Nullable)thumb small:(NSString * _Nullable)small large:(NSString * _Nullable)large __attribute__((swift_name("init(thumb:small:large:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedCoinIconCompanion *companion __attribute__((swift_name("companion")));
- (NSString * _Nullable)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString * _Nullable)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString * _Nullable)component3 __attribute__((swift_name("component3()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedCoinIcon *)doCopyThumb:(NSString * _Nullable)thumb small:(NSString * _Nullable)small large:(NSString * _Nullable)large __attribute__((swift_name("doCopy(thumb:small:large:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinIcon.Companion")))
@interface SharedCoinIconCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCoinIconCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinInfoItem.Companion")))
@interface SharedCoinInfoItemCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCoinInfoItemCompanion *shared __attribute__((swift_name("shared")));
- (NSMutableArray<SharedCoinInfoItem *> *)getScreenItemsCoinInformation:(SharedCoinInformation * _Nullable)coinInformation __attribute__((swift_name("getScreenItems(coinInformation:)")));
@property (readonly) int32_t TYPE_CHART __attribute__((swift_name("TYPE_CHART")));
@property (readonly) int32_t TYPE_DESCRIPTION __attribute__((swift_name("TYPE_DESCRIPTION")));
@property (readonly) int32_t TYPE_SECTION __attribute__((swift_name("TYPE_SECTION")));
@property (readonly) int32_t TYPE_SECTION_TITLE __attribute__((swift_name("TYPE_SECTION_TITLE")));
@property (readonly) int32_t TYPE_TITLE __attribute__((swift_name("TYPE_TITLE")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinInformation")))
@interface SharedCoinInformation : SharedBase
- (instancetype)initWithId:(NSString * _Nullable)id symbol:(NSString * _Nullable)symbol name:(NSString * _Nullable)name hashingAlgorithm:(NSString * _Nullable)hashingAlgorithm blockTimeInMinutes:(NSString * _Nullable)blockTimeInMinutes categories:(NSMutableArray<NSString *> * _Nullable)categories description:(SharedCoinDescription * _Nullable)description links:(SharedCoinLinks * _Nullable)links image:(SharedCoinIcon * _Nullable)image countryOrigin:(NSString * _Nullable)countryOrigin genesisDate:(NSString * _Nullable)genesisDate votesUpPercentage:(SharedDouble * _Nullable)votesUpPercentage votesDownPercentage:(SharedDouble * _Nullable)votesDownPercentage developerScore:(SharedDouble * _Nullable)developerScore communityScore:(SharedDouble * _Nullable)communityScore liquidityScore:(SharedDouble * _Nullable)liquidityScore publicInterestScore:(SharedDouble * _Nullable)publicInterestScore marketCapRank:(SharedInt * _Nullable)marketCapRank communityData:(SharedCoinCommunity * _Nullable)communityData developerData:(SharedCoinDeveloper * _Nullable)developerData marketData:(SharedCoinMarketPriceInfo * _Nullable)marketData __attribute__((swift_name("init(id:symbol:name:hashingAlgorithm:blockTimeInMinutes:categories:description:links:image:countryOrigin:genesisDate:votesUpPercentage:votesDownPercentage:developerScore:communityScore:liquidityScore:publicInterestScore:marketCapRank:communityData:developerData:marketData:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedCoinInformationCompanion *companion __attribute__((swift_name("companion")));
- (NSString * _Nullable)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (SharedDouble * _Nullable)component12 __attribute__((swift_name("component12()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedDouble * _Nullable)component13 __attribute__((swift_name("component13()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedDouble * _Nullable)component14 __attribute__((swift_name("component14()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedDouble * _Nullable)component15 __attribute__((swift_name("component15()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedDouble * _Nullable)component16 __attribute__((swift_name("component16()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedDouble * _Nullable)component17 __attribute__((swift_name("component17()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedInt * _Nullable)component18 __attribute__((swift_name("component18()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedCoinCommunity * _Nullable)component19 __attribute__((swift_name("component19()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString * _Nullable)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedCoinDeveloper * _Nullable)component20 __attribute__((swift_name("component20()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedCoinMarketPriceInfo * _Nullable)component21 __attribute__((swift_name("component21()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString * _Nullable)component3 __attribute__((swift_name("component3()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString * _Nullable)component4 __attribute__((swift_name("component4()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (NSMutableArray<NSString *> * _Nullable)component6 __attribute__((swift_name("component6()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedCoinDescription * _Nullable)component7 __attribute__((swift_name("component7()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedCoinLinks * _Nullable)component8 __attribute__((swift_name("component8()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedCoinIcon * _Nullable)component9 __attribute__((swift_name("component9()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedCoinInformation *)doCopyId:(NSString * _Nullable)id symbol:(NSString * _Nullable)symbol name:(NSString * _Nullable)name hashingAlgorithm:(NSString * _Nullable)hashingAlgorithm blockTimeInMinutes:(NSString * _Nullable)blockTimeInMinutes categories:(NSMutableArray<NSString *> * _Nullable)categories description:(SharedCoinDescription * _Nullable)description links:(SharedCoinLinks * _Nullable)links image:(SharedCoinIcon * _Nullable)image countryOrigin:(NSString * _Nullable)countryOrigin genesisDate:(NSString * _Nullable)genesisDate votesUpPercentage:(SharedDouble * _Nullable)votesUpPercentage votesDownPercentage:(SharedDouble * _Nullable)votesDownPercentage developerScore:(SharedDouble * _Nullable)developerScore communityScore:(SharedDouble * _Nullable)communityScore liquidityScore:(SharedDouble * _Nullable)liquidityScore publicInterestScore:(SharedDouble * _Nullable)publicInterestScore marketCapRank:(SharedInt * _Nullable)marketCapRank communityData:(SharedCoinCommunity * _Nullable)communityData developerData:(SharedCoinDeveloper * _Nullable)developerData marketData:(SharedCoinMarketPriceInfo * _Nullable)marketData __attribute__((swift_name("doCopy(id:symbol:name:hashingAlgorithm:blockTimeInMinutes:categories:description:links:image:countryOrigin:genesisDate:votesUpPercentage:votesDownPercentage:developerScore:communityScore:liquidityScore:publicInterestScore:marketCapRank:communityData:developerData:marketData:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable blockTimeInMinutes __attribute__((swift_name("blockTimeInMinutes")));
@property (readonly) NSMutableArray<NSString *> * _Nullable categories __attribute__((swift_name("categories")));
@property (readonly) SharedCoinCommunity * _Nullable communityData __attribute__((swift_name("communityData")));
@property (readonly) SharedDouble * _Nullable communityScore __attribute__((swift_name("communityScore")));
@property (readonly) NSString * _Nullable countryOrigin __attribute__((swift_name("countryOrigin")));
@property (readonly) SharedCoinDescription * _Nullable description_ __attribute__((swift_name("description_")));
@property (readonly) SharedCoinDeveloper * _Nullable developerData __attribute__((swift_name("developerData")));
@property (readonly) SharedDouble * _Nullable developerScore __attribute__((swift_name("developerScore")));
@property (readonly) NSString * _Nullable genesisDate __attribute__((swift_name("genesisDate")));
@property (readonly) NSString * _Nullable hashingAlgorithm __attribute__((swift_name("hashingAlgorithm")));
@property (readonly) NSString * _Nullable id __attribute__((swift_name("id")));
@property (readonly) SharedCoinIcon * _Nullable image __attribute__((swift_name("image")));
@property (readonly) SharedCoinLinks * _Nullable links __attribute__((swift_name("links")));
@property (readonly) SharedDouble * _Nullable liquidityScore __attribute__((swift_name("liquidityScore")));
@property (readonly) SharedInt * _Nullable marketCapRank __attribute__((swift_name("marketCapRank")));
@property (readonly) SharedCoinMarketPriceInfo * _Nullable marketData __attribute__((swift_name("marketData")));
@property (readonly) NSString * _Nullable name __attribute__((swift_name("name")));
@property (readonly) SharedDouble * _Nullable publicInterestScore __attribute__((swift_name("publicInterestScore")));
@property (readonly) NSString * _Nullable symbol __attribute__((swift_name("symbol")));
@property (readonly) SharedDouble * _Nullable votesDownPercentage __attribute__((swift_name("votesDownPercentage")));
@property (readonly) SharedDouble * _Nullable votesUpPercentage __attribute__((swift_name("votesUpPercentage")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinInformation.Companion")))
@interface SharedCoinInformationCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCoinInformationCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinLinks")))
@interface SharedCoinLinks : SharedBase
- (instancetype)initWithLinks:(NSMutableArray<NSString *> * _Nullable)links blockchainSites:(NSMutableArray<NSString *> * _Nullable)blockchainSites officialForumUrls:(NSMutableArray<NSString *> * _Nullable)officialForumUrls announcementUrls:(NSMutableArray<NSString *> * _Nullable)announcementUrls twitterUsername:(NSString * _Nullable)twitterUsername facebookUsername:(NSString * _Nullable)facebookUsername telegramUsername:(NSString * _Nullable)telegramUsername redditUsername:(NSString * _Nullable)redditUsername repositoriesUrls:(SharedCoinRepository * _Nullable)repositoriesUrls __attribute__((swift_name("init(links:blockchainSites:officialForumUrls:announcementUrls:twitterUsername:facebookUsername:telegramUsername:redditUsername:repositoriesUrls:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedCoinLinksCompanion *companion __attribute__((swift_name("companion")));
- (NSMutableArray<NSString *> * _Nullable)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSMutableArray<NSString *> * _Nullable)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSMutableArray<NSString *> * _Nullable)component3 __attribute__((swift_name("component3()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (SharedCoinRepository * _Nullable)component9 __attribute__((swift_name("component9()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedCoinLinks *)doCopyLinks:(NSMutableArray<NSString *> * _Nullable)links blockchainSites:(NSMutableArray<NSString *> * _Nullable)blockchainSites officialForumUrls:(NSMutableArray<NSString *> * _Nullable)officialForumUrls announcementUrls:(NSMutableArray<NSString *> * _Nullable)announcementUrls twitterUsername:(NSString * _Nullable)twitterUsername facebookUsername:(NSString * _Nullable)facebookUsername telegramUsername:(NSString * _Nullable)telegramUsername redditUsername:(NSString * _Nullable)redditUsername repositoriesUrls:(SharedCoinRepository * _Nullable)repositoriesUrls __attribute__((swift_name("doCopy(links:blockchainSites:officialForumUrls:announcementUrls:twitterUsername:facebookUsername:telegramUsername:redditUsername:repositoriesUrls:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSMutableArray<NSString *> * _Nullable announcementUrls __attribute__((swift_name("announcementUrls")));
@property (readonly) NSMutableArray<NSString *> * _Nullable blockchainSites __attribute__((swift_name("blockchainSites")));
@property (readonly) NSString * _Nullable facebookUsername __attribute__((swift_name("facebookUsername")));
@property (readonly) NSMutableArray<NSString *> * _Nullable links __attribute__((swift_name("links")));
@property (readonly) NSMutableArray<NSString *> * _Nullable officialForumUrls __attribute__((swift_name("officialForumUrls")));
@property (readonly) NSString * _Nullable redditUsername __attribute__((swift_name("redditUsername")));
@property (readonly) SharedCoinRepository * _Nullable repositoriesUrls __attribute__((swift_name("repositoriesUrls")));
@property (readonly) NSString * _Nullable telegramUsername __attribute__((swift_name("telegramUsername")));
@property (readonly) NSString * _Nullable twitterUsername __attribute__((swift_name("twitterUsername")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinLinks.Companion")))
@interface SharedCoinLinksCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCoinLinksCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinMarketPrice.Companion")))
@interface SharedCoinMarketPriceCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCoinMarketPriceCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinMarketPriceInfo")))
@interface SharedCoinMarketPriceInfo : SharedBase
- (instancetype)initWithValue:(SharedCoinMarketPrice * _Nullable)value __attribute__((swift_name("init(value:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedCoinMarketPriceInfoCompanion *companion __attribute__((swift_name("companion")));
- (SharedCoinMarketPrice * _Nullable)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedCoinMarketPriceInfo *)doCopyValue:(SharedCoinMarketPrice * _Nullable)value __attribute__((swift_name("doCopy(value:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedCoinMarketPrice * _Nullable value __attribute__((swift_name("value")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinMarketPriceInfo.Companion")))
@interface SharedCoinMarketPriceInfoCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCoinMarketPriceInfoCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinModel")))
@interface SharedCoinModel : SharedBase
- (instancetype)initWithId:(NSString * _Nullable)id symbol:(NSString * _Nullable)symbol name:(NSString * _Nullable)name image:(NSString * _Nullable)image price:(SharedDouble * _Nullable)price marketGapRank:(SharedInt * _Nullable)marketGapRank percentChange:(SharedDouble * _Nullable)percentChange __attribute__((swift_name("init(id:symbol:name:image:price:marketGapRank:percentChange:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedCoinModelCompanion *companion __attribute__((swift_name("companion")));
- (NSString * _Nullable)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString * _Nullable)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString * _Nullable)component3 __attribute__((swift_name("component3()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString * _Nullable)component4 __attribute__((swift_name("component4()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedDouble * _Nullable)component5 __attribute__((swift_name("component5()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedInt * _Nullable)component6 __attribute__((swift_name("component6()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedDouble * _Nullable)component7 __attribute__((swift_name("component7()"))) __attribute__((deprecated("use corresponding property instead")));
...
@property (readonly) NSString * _Nullable id __attribute__((swift_name("id")));
@property (readonly) NSString * _Nullable image __attribute__((swift_name("image")));
@property (readonly) SharedInt * _Nullable marketGapRank __attribute__((swift_name("marketGapRank")));
@property (readonly) NSString * _Nullable name __attribute__((swift_name("name")));
@property (readonly) SharedDouble * _Nullable percentChange __attribute__((swift_name("percentChange")));
@property (readonly) SharedDouble * _Nullable price __attribute__((swift_name("price")));
@property (readonly) NSString * _Nullable symbol __attribute__((swift_name("symbol")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinModel.Companion")))
@interface SharedCoinModelCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCoinModelCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
- (SharedRealmCoinModel *)toRealmCoinModelModel:(SharedCoinModel *)model __attribute__((swift_name("toRealmCoinModel(model:)")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinRepository")))
@interface SharedCoinRepository : SharedBase
- (instancetype)initWithGithubLinks:(NSMutableArray<NSString *> * _Nullable)githubLinks bitbucketLinks:(NSMutableArray<NSString *> * _Nullable)bitbucketLinks __attribute__((swift_name("init(githubLinks:bitbucketLinks:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedCoinRepositoryCompanion *companion __attribute__((swift_name("companion")));
- (NSMutableArray<NSString *> * _Nullable)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSMutableArray<NSString *> * _Nullable)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedCoinRepository *)doCopyGithubLinks:(NSMutableArray<NSString *> * _Nullable)githubLinks bitbucketLinks:(NSMutableArray<NSString *> * _Nullable)bitbucketLinks __attribute__((swift_name("doCopy(githubLinks:bitbucketLinks:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSMutableArray<NSString *> * _Nullable bitbucketLinks __attribute__((swift_name("bitbucketLinks")));
@property (readonly) NSMutableArray<NSString *> * _Nullable githubLinks __attribute__((swift_name("githubLinks")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinRepository.Companion")))
@interface SharedCoinRepositoryCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCoinRepositoryCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinaFragmentsNavigation")))
@interface SharedCoinaFragmentsNavigation : SharedKotlinEnum<SharedCoinaFragmentsNavigation *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) SharedCoinaFragmentsNavigation *homeTab __attribute__((swift_name("homeTab")));
@property (class, readonly) SharedCoinaFragmentsNavigation *notificationsTab __attribute__((swift_name("notificationsTab")));
@property (class, readonly) SharedCoinaFragmentsNavigation *profileTab __attribute__((swift_name("profileTab")));
+ (SharedKotlinArray<SharedCoinaFragmentsNavigation *> *)values __attribute__((swift_name("values()")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ExchangeModel")))
@interface SharedExchangeModel : SharedBase
- (instancetype)initWithId:(NSString * _Nullable)id name:(NSString * _Nullable)name country:(NSString * _Nullable)country description:(NSString * _Nullable)description url:(NSString * _Nullable)url image:(NSString * _Nullable)image yearEstablished:(SharedInt * _Nullable)yearEstablished __attribute__((swift_name("init(id:name:country:description:url:image:yearEstablished:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedExchangeModelCompanion *companion __attribute__((swift_name("companion")));
- (NSString * _Nullable)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString * _Nullable)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString * _Nullable)component3 __attribute__((swift_name("component3()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString * _Nullable)component4 __attribute__((swift_name("component4()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString * _Nullable)component5 __attribute__((swift_name("component5()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString * _Nullable)component6 __attribute__((swift_name("component6()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedInt * _Nullable)component7 __attribute__((swift_name("component7()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedExchangeModel *)doCopyId:(NSString * _Nullable)id name:(NSString * _Nullable)name country:(NSString * _Nullable)country description:(NSString * _Nullable)description url:(NSString * _Nullable)url image:(NSString * _Nullable)image yearEstablished:(SharedInt * _Nullable)yearEstablished __attribute__((swift_name("doCopy(id:name:country:description:url:image:yearEstablished:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSString *)getCountryText __attribute__((swift_name("getCountryText()")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property (readonly) SharedInt * _Nullable yearEstablished __attribute__((swift_name("yearEstablished")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ExchangeModel.Companion")))
@interface SharedExchangeModelCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedExchangeModelCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
- (SharedRealmExchangeModel *)toRealmExchangeModelModel:(SharedExchangeModel *)model __attribute__((swift_name("toRealmExchangeModel(model:)")));
@end
...
- (id<SharedKotlinKClass>)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (id<SharedKotlinKType>)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
- (id<SharedKotlinKType> _Nullable)component3 __attribute__((swift_name("component3()"))) __attribute__((deprecated("use corresponding property instead")));
...
@interface SharedKtor_utilsTypeInfo (Extensions)
- (SharedKtor_utilsTypeInfo *)ofInnerClassParameter __attribute__((swift_name("ofInnerClassParameter()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ApplicationExtKt")))
@interface SharedApplicationExtKt : SharedBase
+ (NSString *)formatDecimalSeparator:(double)receiver __attribute__((swift_name("formatDecimalSeparator(_:)")));
+ (NSString *)formatDecimalSeparator_:(int32_t)receiver __attribute__((swift_name("formatDecimalSeparator(__:)")));
+ (NSString *)formatDecimalSeparator__:(int64_t)receiver __attribute__((swift_name("formatDecimalSeparator(___:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinaContextImplementationProviderKt")))
@interface SharedCoinaContextImplementationProviderKt : SharedBase
...
@property (readonly) SharedLibrary_baseLogConfiguration *log __attribute__((swift_name("log")));
...
- (SharedKotlinKVariance * _Nullable)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (id<SharedKotlinKType> _Nullable)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (SharedKtor_utilsTypeInfo *)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (instancetype)initWithLevel:(SharedLibrary_baseLogLevel *)level loggers:(NSArray<id<SharedLibrary_baseRealmLogger>> *)loggers __attribute__((swift_name("init(level:loggers:)"))) __attribute__((objc_designated_initializer));
- (SharedLibrary_baseLogLevel *)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSArray<id<SharedLibrary_baseRealmLogger>> *)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
...
@required
- (id<SharedLibrary_baseRealmProperty> _Nullable)getKey__:(NSString *)key __attribute__((swift_name("get(key__:)")));
@property (readonly) BOOL isEmbedded __attribute__((swift_name("isEmbedded")));
@property (readonly) NSString *name __attribute__((swift_name("name")));
...
- (SharedKtor_utilsWeekDay *)component4 __attribute__((swift_name("component4()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (SharedKtor_utilsMonth *)component7 __attribute__((swift_name("component7()"))) __attribute__((deprecated("use corresponding property instead")));
...
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly, getter=companion) SharedLibrary_baseLogLevelCompanion *companion __attribute__((swift_name("companion")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Library_baseLogLevel.Companion")))
@interface SharedLibrary_baseLogLevelCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedLibrary_baseLogLevelCompanion *shared __attribute__((swift_name("shared")));
- (SharedLibrary_baseLogLevel *)fromCoreLogLevelCoreLogLevel:(SharedCinteropCoreLogLevel *)coreLogLevel __attribute__((swift_name("fromCoreLogLevel(coreLogLevel:)")));
@end

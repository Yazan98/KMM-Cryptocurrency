...
*/
- (void)getCategoriesDatabase:(SharedCategoriesDataSource *)database onNewStateTriggered:(void (^)(SharedCoinaApplicationState<NSMutableArray<SharedCategory *> *> *))onNewStateTriggered completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("getCategories(database:onNewStateTriggered:completionHandler:)")));
...
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (NSMutableArray<SharedCategory *> *)getCategories __attribute__((swift_name("getCategories()")));
- (NSString *)getDataSourceName __attribute__((swift_name("getDataSourceName()")));
- (NSSet<id<SharedKotlinKClass>> *)getSchema __attribute__((swift_name("getSchema()")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)writeCategoriesDataCategories:(NSMutableArray<SharedCategory *> *)categories completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("writeCategoriesData(categories:completionHandler:)")));
@end
...
- (SharedCategory *)toCategoryRealmCategory:(SharedRealmCategory *)realmCategory __attribute__((swift_name("toCategory(realmCategory:)")));
@end
...
- (SharedCategory *)doCopyId:(NSString * _Nullable)id name:(NSString * _Nullable)name content:(NSString * _Nullable)content marketGap:(SharedDouble * _Nullable)marketGap topCoins:(NSMutableArray<NSString *> * _Nullable)topCoins __attribute__((swift_name("doCopy(id:name:content:marketGap:topCoins:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property NSString * _Nullable content __attribute__((swift_name("content")));
...
- (SharedRealmCategory *)toRealmCategoryCategory:(SharedCategory *)category __attribute__((swift_name("toRealmCategory(category:)")));
@end
